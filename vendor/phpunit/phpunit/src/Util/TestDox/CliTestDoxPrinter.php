...
class CliTestDoxPrinter extends TestDoxPrinter {
	 ...
	 */
	private const PREFIX_SIMPLE = array(
		'default' => '│',
		'start'   => '│',
		'message' => '│',
		'diff'    => '│',
	 ...
	 */
	private const PREFIX_DECORATED = array(
		'default' => '│',
		'start'   => '┐',
		'message' => '├',
		'diff'    => '┊',
	...
	private const SPINNER_ICONS = array(
		" \e[36m◐\e[0m running tests",
		" \e[36m◓\e[0m running tests",
		" \e[36m◑\e[0m running tests",
		" \e[36m◒\e[0m running tests",
	);
	private const STATUS_STYLES = array(
		BaseTestRunner::STATUS_PASSED     => array(
			'symbol' => '✔',
			'color'  => 'fg-green',
		),
		BaseTestRunner::STATUS_ERROR      => array(
			'symbol'  => '✘',
			'color'   => 'fg-yellow',
			'message' => 'bg-yellow,fg-black',
		),
		BaseTestRunner::STATUS_FAILURE    => array(
			'symbol'  => '✘',
			'color'   => 'fg-red',
			'message' => 'bg-red,fg-white',
		),
		BaseTestRunner::STATUS_SKIPPED    => array(
			'symbol'  => '↩',
			'color'   => 'fg-cyan',
			'message' => 'fg-cyan',
		),
		BaseTestRunner::STATUS_RISKY      => array(
			'symbol'  => '☢',
			'color'   => 'fg-yellow',
			'message' => 'fg-yellow',
		),
		BaseTestRunner::STATUS_INCOMPLETE => array(
			'symbol'  => '∅',
			'color'   => 'fg-yellow',
			'message' => 'fg-yellow',
		),
		BaseTestRunner::STATUS_WARNING    => array(
			'symbol'  => '⚠',
			'color'   => 'fg-yellow',
			'message' => 'fg-yellow',
		),
		BaseTestRunner::STATUS_UNKNOWN    => array(
			'symbol'  => '?',
			'color'   => 'fg-blue',
	 ...
	 * @var int[]
	 */
	private $nonSuccessfulTestResults = array();
