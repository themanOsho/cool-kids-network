...
class CoolKidsNetwork {
    public function __construct() {
        ...
        add_action('admin_menu', [$this, 'add_admin_page']); // Add admin menu
    }
    /**
    ...
    public function add_admin_page() {
        add_menu_page(
            ...
            [$this, 'render_admin_page'],       // Callback to display page
    ...
    public function render_admin_page() {
        ...
        $plugin_roles = ['cool_kid', 'cooler_kid', 'coolest_kid'];
        $users = get_users([
    ...
    public function register_roles() {
        ...
        add_role('cooler_kid', 'Cooler Kid', ['read' => true, 'view_users_basic' => true]);
